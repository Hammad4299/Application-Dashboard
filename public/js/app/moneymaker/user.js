...
Object.defineProperty(exports, "__esModule", { value: true });
var ReportingApiHelper_1 = __webpack_require__(29);
var Enumerable = __webpack_require__(30);

var VisitsActivity = function () {
    _createClass(VisitsActivity, [{
        key: "getVisitData",
        value: function getVisitData() {
            var a = Enumerable.from(this.flattenedScreens).groupBy(function (x) {
                return x.visitId;
            }).select(function (x, y) {
                return { a: x, b: y };
            });
...
(function (root, undefined) {
    ...
    // module export
    if ("function" === Types.Function && __webpack_require__(31)) { // AMD
...
var globals_1 = __webpack_require__(0);
var MoneyMakerPiwikHelper_1 = __webpack_require__(28);
var piwikHelper = new MoneyMakerPiwikHelper_1.default();
$(document).on('click', '.js-analytics-detail', function () {
    piwikHelper.getUserAnalyticDetail($(this).attr('data-uid'), null, null, function (data) {
