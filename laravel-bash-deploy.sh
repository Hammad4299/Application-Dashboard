...
cp -rf "${current_dir_base}${deployment_info_folder}.env" "${current_dir_base}.env"
cp -rf "${current_dir_base}${deployment_info_folder}webpack-path-base.config.js" "${current_dir_base}webpack-path-base.config.js"
...
yarn install
yarn run build
apidoc -i "${current_dir_base}app" -o "${current_dir_base}public/apidoc"
